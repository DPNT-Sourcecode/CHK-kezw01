...
public class CheckoutSolution {
    ...
    private SpecialOffer getBestSpecialOffer(int amountOfItems, ArrayList<SpecialOffer> specialOffers)
    {
    ...
    private HashMap<String, ArrayList<SpecialOffer>> getMapSKUsSpecialOffers()
    {
